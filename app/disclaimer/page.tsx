		...
		<main className="min-h-screen bg-elegance">
			...
			<section className="bg-neutral-900 text-white">
				<div className="container-elegance section-elegance text-center">
					<h1 className="text-4xl text-elegance-heading text-white mb-6">
			...
			{/* Content Section */}
			<section className="container-elegance section-elegance space-y-12">
				{/* Allergen Disclaimer */}
				...
				<div className="bg-neutral-900 text-white p-8 text-center">
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center">
						<div className="inline-flex items-center gap-2 bg-white/10 px-6 py-3">
